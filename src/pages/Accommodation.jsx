...
import { MapPin, Bed, Wifi, Coffee, Shield, Bus, ArrowRight } from "lucide-react";
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
                ...
                >
                    ...
                    <p className="text-gray-400 mb-8 leading-relaxed">
                        Experience the full festival atmosphere by staying right in the heart
                        of the action. Our hostels provide a comfortable and secure
                    ...
                    <div className="mt-8">
                        <Link
                            to="/register?type=accommodation"
